...
Source Sans 3 via `next/font/google` (`display: 'swap'`, `subsets: ['latin']`, weights 400/500/600/700). Source Sans 3 is Adobe's open-source humanist sans-serif — formerly Source Sans Pro — and is the standard font across the thefairies.ie design system. It is clean and highly legible at all sizes, equally suited to UI chrome and long-form text.

```
font-family: 'Source Sans 3', 'Segoe UI', Arial, ui-sans-serif, system-ui, -apple-system, sans-serif;
```
